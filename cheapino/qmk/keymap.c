...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_3(
       ...
       KC_Z,         KC_X,         KC_C,         KC_V,          KC_B,        KC_N,  KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,
                                   TO(1),        KC_BSPC,       KC_NO,       KC_NO, KC_SPC,       KC_ENT
       ),

    [1] = LAYOUT_split_3x5_3(
       KC_1,    KC_2,    KC_3,    KC_4,    KC_5,        KC_6,      KC_7,    KC_8,    KC_9,    KC_0, 
       KC_LALT, KC_LGUI, KC_LSFT, KC_LCTL, KC_TAB,      KC_DELETE, KC_RCTL, KC_RSFT, KC_RGUI, KC_RALT,
       KC_NO,   KC_GRV,  KC_MINS, KC_EQL,  KC_LBRC,     KC_RBRC,   KC_QUOT, KC_BSLS, KC_NO,   KC_NO,
...
const uint16_t PROGMEM to2_layer1[] = {KC_ENT, TO(1), COMBO_END};
